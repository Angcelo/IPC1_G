...
import static login.Login.usuarios;
...
public class PestanaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TxtAlertas = new javax.swing.JLabel();
        ...
        TxtAlertas.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        TxtAlertas.setForeground(new java.awt.Color(255, 153, 153));
        TxtAlertas.setText("Alerta");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < usuarios.length; i++) {
            if (usuarios[i] != null) {
                int rol = usuarios[i].Verificar(nombre, contrasena);
                if (rol != 0) {
                    switch (rol) {
                        case 1:
                    ...
                    TxtAlertas.setText("Alerta: Usuario o Contrasena Incorrectos");
                }
            }
        }
    ...
    private javax.swing.JLabel TxtAlertas;
